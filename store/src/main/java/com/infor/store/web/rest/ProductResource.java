...
import com.infor.store.domain.Product;
import com.infor.store.repository.ProductRepository;
import com.infor.store.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.infor.store.domain.Product}.
 */
@RestController
@RequestMapping("/api")
@Transactional
