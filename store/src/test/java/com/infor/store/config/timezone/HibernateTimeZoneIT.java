package com.infor.store.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.infor.store.IntegrationTest;
import com.infor.store.repository.timezone.DateTimeWrapper;
import com.infor.store.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM infor_date_time_wrapper where id=%d", fieldName, id);
    }
