...
import com.infor.blog.domain.Blog;
import com.infor.blog.repository.BlogRepository;
import com.infor.blog.repository.UserRepository;
import com.infor.blog.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.infor.blog.domain.Blog}.
 */
@RestController
@RequestMapping("/api")
